...
func TestDecodeInboundPush(t *testing.T) {
	cb := &buffer{}; cb.writeStringField(1, "hello")
	eb := &buffer{}; eb.writeStringField(1, "TIMTextElem"); eb.writeBytesField(2, cb.bytes())
	pb := &buffer{}
	pb.writeStringField(1, "C2CCallback"); pb.writeStringField(2, "from-user")
	pb.writeStringField(3, "bot"); pb.writeStringField(4, "User1")
	pb.writeStringField(12, "msg-001"); pb.writeBytesField(13, eb.bytes())
...
func TestDecodeInboundPushGroup(t *testing.T) {
	cb := &buffer{}; cb.writeStringField(1, "群消息")
	eb := &buffer{}; eb.writeStringField(1, "TIMTextElem"); eb.writeBytesField(2, cb.bytes())
	pb := &buffer{}
	pb.writeStringField(2, "from-user"); pb.writeStringField(4, "User1")
	pb.writeStringField(6, "grp-001"); pb.writeStringField(7, "测试群")
	pb.writeStringField(12, "msg-002"); pb.writeBytesField(13, eb.bytes())
...
func TestParseRepeatedFields(t *testing.T) {
	b := &buffer{}
	b.writeStringField(1, "a"); b.writeStringField(2, "x"); b.writeStringField(1, "b")
